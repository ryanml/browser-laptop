    ...
    return <section>
      <main className={css(styles.advancedTabMain)}>
        ...
        <SettingsList>
          ...
          <SettingCheckbox dataL10nId='enableNotifications' prefKey={settings.NOTIFICATIONS_ENABLED} settings={this.props.settings} onChangeSetting={this.props.onChangeSetting} />
        </SettingsList>
